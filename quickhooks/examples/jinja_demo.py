...
from quickhooks.utils import CodeGenerator, TemplateEngine, TemplateRenderer
...
def demo_code_generation():
    ...
    test_code = generator.generate_test_class(
        test_subject="security_validator", test_type="unit"
    )
    print(test_code)
    ...
    config_code = generator.generate_config_class(
        config_name="file_validator", fields=config_fields
    )
    print(config_code)
