...
class LanguageAwareLinter:
    ...
    def __init__(self):
        ...
        self.linter_mappings = {
            ...
            "javascript": {
                "primary": "eslint",
                "commands": {"eslint": "npx eslint . --ext .js,.jsx"},
            },
            "typescript": {
                "primary": "eslint",
                "commands": {"eslint": "npx eslint . --ext .ts,.tsx"},
            },
            "go": {
                "primary": "golangci-lint",
                "commands": {"golangci-lint": "golangci-lint run ./..."},
            },
            "rust": {
                "primary": "clippy",
                "commands": {"clippy": "cargo clippy -- -D warnings"},
            },
            "ruby": {"primary": "rubocop", "commands": {"rubocop": "rubocop"}},
            "java": {
                "primary": "checkstyle",
    ...
    def transform_command(self, command: str, language: str) -> str | None:
        ...
        if any(linter in command for linter in linter_config["commands"]):
            return None

        # Return the primary linter command
        return linter_config["commands"][primary_linter]

    def get_lint_command_for_file(self, filepath: str) -> str | None:
...
def main():
    ...
    try:
        ...
        print(f"Language-aware linter hook error: {e!s}", file=sys.stderr)
        sys.exit(0)
